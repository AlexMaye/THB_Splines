...
def make_bilinear_kernel(dtype, rtype, ufcx_kernel,
...
def make_linear_kernel(dtype, rtype, ufcx_kernel,
                          padded_dofs, local_dofs):
    ffi = cffi.FFI()
...
def make_vector_bilinear_kernel(dtype, rtype, ufcx_kernel, padded_dofs, local_dofs):
    ffi = cffi.FFI()
...
def make_vector_linear_kernel(dtype, rtype, ufcx_kernel, padded_dofs, local_dofs):
    ffi = cffi.FFI()
    local_dofs_vec = 2*local_dofs
    padded_dofs_vec = 2*padded_dofs
